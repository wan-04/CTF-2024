...
public final class LimitedDispatcher extends CoroutineDispatcher implements Runnable, Delay {
    ...
    public void mo1635scheduleResumeAfterDelay(long j, CancellableContinuation<? super Unit> cancellableContinuation) {
        this.$$delegate_0.mo1635scheduleResumeAfterDelay(j, cancellableContinuation);
    }
        ...
        while (true) {
            ...
            if (task != null) {
                ...
                if (fairnessCounter >= 16 && this.dispatcher.isDispatchNeeded(this)) {
                    this.dispatcher.mo1634dispatch(this, this);
                    return;
                }
            } else {
