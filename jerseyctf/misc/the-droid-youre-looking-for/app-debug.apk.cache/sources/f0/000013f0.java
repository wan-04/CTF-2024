...
public final class URandomKt {
    public static final int nextUInt(Random $this$nextUInt) {
        ...
        return UInt.m191constructorimpl($this$nextUInt.nextInt());
    }
    ...
    public static final int m1322nextUInta8DCA5k(Random nextUInt, int from, int until) {
        ...
        return UInt.m191constructorimpl(signedResult);
    }
    ...
    public static final int nextUInt(Random $this$nextUInt, UIntRange range) {
        ...
        return UnsignedKt.uintCompare(range.m1327getLastpVg5ArA(), -1) < 0 ? m1322nextUInta8DCA5k($this$nextUInt, range.m1326getFirstpVg5ArA(), UInt.m191constructorimpl(range.m1327getLastpVg5ArA() + 1)) : UnsignedKt.uintCompare(range.m1326getFirstpVg5ArA(), 0) > 0 ? UInt.m191constructorimpl(m1322nextUInta8DCA5k($this$nextUInt, UInt.m191constructorimpl(range.m1326getFirstpVg5ArA() - 1), range.m1327getLastpVg5ArA()) + 1) : nextUInt($this$nextUInt);
    }
    ...
    public static final long nextULong(Random $this$nextULong, ULongRange range) {
        ...
        if (UnsignedKt.ulongCompare(range.m1334getLastsVKNKU(), -1L) < 0) {
            return m1325nextULongjmpaWc($this$nextULong, range.m1333getFirstsVKNKU(), ULong.m269constructorimpl(range.m1334getLastsVKNKU() + ULong.m269constructorimpl(1 & 4294967295L)));
        }
        if (UnsignedKt.ulongCompare(range.m1333getFirstsVKNKU(), 0L) > 0) {
            long j = 1 & 4294967295L;
            return ULong.m269constructorimpl(m1325nextULongjmpaWc($this$nextULong, ULong.m269constructorimpl(range.m1333getFirstsVKNKU() - ULong.m269constructorimpl(j)), range.m1334getLastsVKNKU()) + ULong.m269constructorimpl(j));
        }
    ...
    public static final byte[] nextUBytes(Random $this$nextUBytes, int size) {
        ...
        return UByteArray.m167constructorimpl($this$nextUBytes.nextBytes(size));
    }
    ...
    public static final void m1317checkUIntRangeBoundsJ1ME1BU(int from, int until) {
        if (!(UnsignedKt.uintCompare(until, from) > 0)) {
            throw new IllegalArgumentException(RandomKt.boundsErrorMessage(UInt.m185boximpl(from), UInt.m185boximpl(until)).toString());
        }
    }
