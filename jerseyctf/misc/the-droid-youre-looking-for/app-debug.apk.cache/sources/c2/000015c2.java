...
public final class HandlerContext extends HandlerDispatcher implements Delay {
    ...
    public static /* synthetic */ void m1582$r8$lambda$TOZof2GYGCn1P43qXNY1O5Gvm8(HandlerContext handlerContext, Runnable runnable) {
        m1583invokeOnTimeout$lambda3(handlerContext, runnable);
    }
    ...
    public void mo1634dispatch(CoroutineContext context, Runnable block) {
    ...
    public void mo1635scheduleResumeAfterDelay(long timeMillis, final CancellableContinuation<? super Unit> cancellableContinuation) {
        ...
        if (this.handler.postDelayed(block, RangesKt.coerceAtMost(timeMillis, (long) DurationKt.MAX_MILLIS))) {
            return new DisposableHandle() { // from class: kotlinx.coroutines.android.HandlerContext$$ExternalSyntheticLambda0
                ...
                public final void dispose() {
                    HandlerContext.m1582$r8$lambda$TOZof2GYGCn1P43qXNY1O5Gvm8(HandlerContext.this, block);
                }
            };
        }
        cancelOnRejection(context, block);
    ...
    public static final void m1583invokeOnTimeout$lambda3(HandlerContext this$0, Runnable $block) {
    ...
    private final void cancelOnRejection(CoroutineContext context, Runnable block) {
        ...
        Dispatchers.getIO().mo1634dispatch(context, block);
    }
