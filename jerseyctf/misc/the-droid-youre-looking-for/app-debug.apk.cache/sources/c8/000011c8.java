...
public final class ResultKt {
    ...
    private static final <R> Object runCatching(Function0<? extends R> block) {
        ...
        try {
            ...
            return Result.m97constructorimpl(block.invoke());
        } catch (Throwable e) {
            Result.Companion companion2 = Result.Companion;
            return Result.m97constructorimpl(createFailure(e));
        }
    }
    ...
    private static final <T, R> Object runCatching(T t, Function1<? super T, ? extends R> block) {
        ...
        try {
            Result.Companion companion = Result.Companion;
            return Result.m97constructorimpl(block.invoke(t));
        } catch (Throwable e) {
            Result.Companion companion2 = Result.Companion;
            return Result.m97constructorimpl(createFailure(e));
        }
    ...
    private static final <R, T extends R> R getOrElse(Object $this$getOrElse, Function1<? super Throwable, ? extends R> onFailure) {
        ...
        Throwable exception = Result.m100exceptionOrNullimpl($this$getOrElse);
    ...
    private static final <R, T extends R> R getOrDefault(Object $this$getOrDefault, R r) {
        return Result.m103isFailureimpl($this$getOrDefault) ? r : $this$getOrDefault;
    }
    ...
    private static final <R, T> R fold(Object $this$fold, Function1<? super T, ? extends R> onSuccess, Function1<? super Throwable, ? extends R> onFailure) {
        ...
        Intrinsics.checkNotNullParameter(onFailure, "onFailure");
        Throwable exception = Result.m100exceptionOrNullimpl($this$fold);
    ...
    private static final <R, T> Object map(Object $this$map, Function1<? super T, ? extends R> transform) {
        ...
        if (Result.m104isSuccessimpl($this$map)) {
            Result.Companion companion = Result.Companion;
            return Result.m97constructorimpl(transform.invoke($this$map));
        }
        return Result.m97constructorimpl($this$map);
    }

    private static final <R, T> Object mapCatching(Object $this$mapCatching, Function1<? super T, ? extends R> transform) {
        Intrinsics.checkNotNullParameter(transform, "transform");
        if (Result.m104isSuccessimpl($this$mapCatching)) {
            try {
                Result.Companion companion = Result.Companion;
                Object $this$mapCatching_u24lambda_u2d3 = Result.m97constructorimpl(transform.invoke($this$mapCatching));
                return $this$mapCatching_u24lambda_u2d3;
            } catch (Throwable th) {
                Result.Companion companion2 = Result.Companion;
                return Result.m97constructorimpl(createFailure(th));
            }
        }
        return Result.m97constructorimpl($this$mapCatching);
    }

    private static final <R, T extends R> Object recover(Object $this$recover, Function1<? super Throwable, ? extends R> transform) {
        Intrinsics.checkNotNullParameter(transform, "transform");
        Throwable exception = Result.m100exceptionOrNullimpl($this$recover);
        if (exception == null) {
            return $this$recover;
        }
        Result.Companion companion = Result.Companion;
        return Result.m97constructorimpl(transform.invoke(exception));
    }
    ...
    private static final <R, T extends R> Object recoverCatching(Object $this$recoverCatching, Function1<? super Throwable, ? extends R> transform) {
        Intrinsics.checkNotNullParameter(transform, "transform");
        Throwable exception = Result.m100exceptionOrNullimpl($this$recoverCatching);
        if (exception == null) {
            return $this$recoverCatching;
        }
        try {
            Result.Companion companion = Result.Companion;
            Object $this$recoverCatching_u24lambda_u2d5 = Result.m97constructorimpl(transform.invoke(exception));
    ...
    private static final <T> Object onFailure(Object $this$onFailure, Function1<? super Throwable, Unit> action) {
        ...
        Throwable it = Result.m100exceptionOrNullimpl($this$onFailure);
        if (it != null) {
            action.invoke(it);
        }
    ...
    private static final <T> Object onSuccess(Object $this$onSuccess, Function1<? super T, Unit> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        if (Result.m104isSuccessimpl($this$onSuccess)) {
