...
public interface ReceiveChannel<E> {
    ...
    Object mo1587tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object result = receiveChannel.mo1587tryReceivePtdJZtk();
            if (ChannelResult.m1603isSuccessimpl(result)) {
                return (E) ChannelResult.m1599getOrThrowimpl(result);
            }
            Throwable m1597exceptionOrNullimpl = ChannelResult.m1597exceptionOrNullimpl(result);
            if (m1597exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m1597exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r3, kotlin.coroutines.Continuation<? super E> r4) {
            ...
            L2d:
                ...
                java.lang.Object r3 = r3.m1605unboximpl()
                goto L45
            L38:
                kotlin.ResultKt.throwOnFailure(r0)
                r2 = 1
                r4.label = r2
                java.lang.Object r3 = r3.mo1586receiveCatchingJP2dKIU(r4)
                if (r3 != r1) goto L45
                return r1
            L45:
                java.lang.Object r3 = kotlinx.coroutines.channels.ChannelResult.m1598getOrNullimpl(r3)
                return r3
            */
