...
public final class FlowKt {
    ...
    public static final <T> Flow<T> m1611catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        return FlowKt__ErrorsKt.m1618catch(flow, function3);
    }
    ...
    public static final <T> Flow<T> m1612debounceHG0u8IE(Flow<? extends T> flow, long timeout) {
        return FlowKt__DelayKt.m1614debounceHG0u8IE(flow, timeout);
    }
    ...
    public static final <T> Flow<T> m1613sampleHG0u8IE(Flow<? extends T> flow, long period) {
        return FlowKt__DelayKt.m1615sampleHG0u8IE(flow, period);
    }
