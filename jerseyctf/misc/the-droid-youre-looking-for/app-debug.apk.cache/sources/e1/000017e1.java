...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                m97constructorimpl = Result.m97constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
                ...
                return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$4
                    ...
                    public final Throwable invoke(Throwable e) {
                        ...
                        if (newInstance != null) {
                            ...
                            it.initCause(e);
                            m97constructorimpl = Result.m97constructorimpl(it);
                            if (Result.m103isFailureimpl(m97constructorimpl)) {
                                m97constructorimpl = null;
                            }
                            return (Throwable) m97constructorimpl;
                        }
            ...
            case 1:
                ...
                return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$2
                    ...
                    public final Throwable invoke(Throwable e) {
                        ...
                        if (newInstance != null) {
                            m97constructorimpl = Result.m97constructorimpl((Throwable) newInstance);
                            if (Result.m103isFailureimpl(m97constructorimpl)) {
                                m97constructorimpl = null;
                            }
                            return (Throwable) m97constructorimpl;
    ...
    private static final Function1<Throwable, Throwable> safeCtor(final Function1<? super Throwable, ? extends Throwable> function1) {
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$safeCtor$1
            ...
            public final Throwable invoke(Throwable e) {
                ...
                try {
                    Result.Companion companion = Result.Companion;
                    m97constructorimpl = Result.m97constructorimpl(function12.invoke(e));
                } catch (Throwable th) {
                    Result.Companion companion2 = Result.Companion;
                    m97constructorimpl = Result.m97constructorimpl(ResultKt.createFailure(th));
                }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int defaultValue) {
        Integer m97constructorimpl;
        JvmClassMappingKt.getKotlinClass(cls);
        try {
            Result.Companion companion = Result.Companion;
            m97constructorimpl = Result.m97constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m97constructorimpl = Result.m97constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m103isFailureimpl(m97constructorimpl)) {
            m97constructorimpl = valueOf;
        }
        return ((Number) m97constructorimpl).intValue();
    }
