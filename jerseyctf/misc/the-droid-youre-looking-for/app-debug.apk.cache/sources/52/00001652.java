...
public final class AgentPremain {
    ...
    public static /* synthetic */ void $r8$lambda$8e1eAWGNJu9vYr96rU9gzKJ_uMQ(Signal signal) {
        m1610installSignalHandler$lambda1(signal);
    }
    ...
    static {
        ...
        try {
            ...
            m97constructorimpl = Result.m97constructorimpl(property == null ? null : Boolean.valueOf(Boolean.parseBoolean(property)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m97constructorimpl = Result.m97constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = Result.m103isFailureimpl(m97constructorimpl) ? null : m97constructorimpl;
    ...
    public static final void m1610installSignalHandler$lambda1(Signal it) {
