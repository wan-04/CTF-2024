...
final class ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1<E, R> extends SuspendLambda implements Function2<ChannelResult<? extends E>, Continuation<? super R>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
        return m1609invokeWpGqRn0(((ChannelResult) obj).m1605unboximpl(), (Continuation) obj2);
    }

    /* renamed from: invoke-WpGqRn0  reason: not valid java name */
    public final Object m1609invokeWpGqRn0(Object obj, Continuation<? super R> continuation) {
        return ((ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1) create(ChannelResult.m1593boximpl(obj), continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                Object it = ((ChannelResult) this.L$0).m1605unboximpl();
                Throwable it2 = ChannelResult.m1597exceptionOrNullimpl(it);
                if (it2 != null) {
                    throw it2;
                }
                Object m1598getOrNullimpl = ChannelResult.m1598getOrNullimpl(it);
                this.label = 1;
                Object it3 = this.$block.invoke(m1598getOrNullimpl, this);
