...
public final class HandlerDispatcherKt {
    ...
    public static /* synthetic */ void $r8$lambda$Z1vOW_gMqzuAA1kBf19jmX0gPxw(CancellableContinuation cancellableContinuation, long j) {
        m1584postFrameCallback$lambda6(cancellableContinuation, j);
    }
    ...
    static {
        ...
        try {
            ...
            m97constructorimpl = Result.m97constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m97constructorimpl = Result.m97constructorimpl(ResultKt.createFailure(th));
        }
        Main = Result.m103isFailureimpl(m97constructorimpl) ? null : m97constructorimpl;
    }
    ...
    public static final Object awaitFrame(Continuation<? super Long> continuation) {
        ...
        Dispatchers.getMain().mo1634dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrame$lambda-3$$inlined$Runnable$1
    ...
    public static final void m1584postFrameCallback$lambda6(CancellableContinuation $cont, long nanos) {
