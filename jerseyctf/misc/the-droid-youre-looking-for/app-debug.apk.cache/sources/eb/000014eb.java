...
public final class UStringsKt {
    ...
    public static final String m1401toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m1403toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m1402toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
    ...
    public static final String m1400toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final byte toUByte(String $this$toUByte) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m164unboximpl();
        }
    ...
    public static final short toUShort(String $this$toUShort) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m424unboximpl();
        }
    ...
    public static final int toUInt(String $this$toUInt) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m242unboximpl();
        }
    ...
    public static final long toULong(String $this$toULong) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m320unboximpl();
        }
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        if (uIntOrNull != null) {
            int m242unboximpl = uIntOrNull.m242unboximpl();
            if (UnsignedKt.uintCompare(m242unboximpl, UInt.m191constructorimpl(255)) > 0) {
                return null;
            }
            return UByte.m109boximpl(UByte.m115constructorimpl((byte) m242unboximpl));
        }
        return null;
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        if (uIntOrNull != null) {
            int m242unboximpl = uIntOrNull.m242unboximpl();
            if (UnsignedKt.uintCompare(m242unboximpl, UInt.m191constructorimpl(SupportMenu.USER_MASK)) > 0) {
                return null;
            }
            return UShort.m369boximpl(UShort.m375constructorimpl((short) m242unboximpl));
        }
        return null;
    }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m191constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            if (UnsignedKt.uintCompare(result, limitBeforeMul) > 0) {
                ...
                limitBeforeMul = UnsignedKt.m444uintDivideJ1ME1BU(-1, uradix);
                if (UnsignedKt.uintCompare(result, limitBeforeMul) > 0) {
                    return null;
                }
            }
            int result2 = UInt.m191constructorimpl(result * uradix);
            result = UInt.m191constructorimpl(UInt.m191constructorimpl(digit) + result2);
            if (UnsignedKt.uintCompare(result, result2) < 0) {
                return null;
            }
        }
        return UInt.m185boximpl(result);
    }
        ...
        while (i2 < length) {
            ...
            if (UnsignedKt.ulongCompare(result, limitBeforeMul) > 0) {
                if (limitBeforeMul == 512409557603043100L) {
                    limitBeforeMul = UnsignedKt.m446ulongDivideeb3DHEI(-1L, uradix);
                    if (UnsignedKt.ulongCompare(result, limitBeforeMul) > 0) {
                        return null;
                    }
                } else {
            ...
            result = ULong.m269constructorimpl(ULong.m269constructorimpl(UInt.m191constructorimpl(digit) & 4294967295L) + result2);
