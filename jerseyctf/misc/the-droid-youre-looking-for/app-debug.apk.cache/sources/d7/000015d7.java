...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    public final Object mo1588trySendJP2dKIU(E e) {
        Object result = offerInternal(e);
        if (result == AbstractChannelKt.OFFER_SUCCESS) {
            return ChannelResult.Companion.m1608successJP2dKIU(Unit.INSTANCE);
        }
        if (result == AbstractChannelKt.OFFER_FAILED) {
            Closed closedForSend = getClosedForSend();
            return closedForSend == null ? ChannelResult.Companion.m1607failurePtdJZtk() : ChannelResult.Companion.m1606closedJP2dKIU(helpCloseAndGetSendException(closedForSend));
        } else if (result instanceof Closed) {
            return ChannelResult.Companion.m1606closedJP2dKIU(helpCloseAndGetSendException((Closed) result));
        } else {
    ...
    public final Object sendSuspend(E e, Continuation<? super Unit> continuation) {
        ...
        while (true) {
            ...
            if (offerResult == AbstractChannelKt.OFFER_SUCCESS) {
                ...
                cont.resumeWith(Result.m97constructorimpl(Unit.INSTANCE));
                break;
    ...
    public final void helpCloseAndResumeWithSendException(Continuation<?> continuation, E e, Closed<?> closed) {
        ...
        if (function1 != null && (it = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            ...
            Result.Companion companion = Result.Companion;
            continuation.resumeWith(Result.m97constructorimpl(ResultKt.createFailure(it)));
            return;
        }
        Result.Companion companion2 = Result.Companion;
        continuation.resumeWith(Result.m97constructorimpl(ResultKt.createFailure(sendException)));
    }
    ...
    */
    ...
    private final void helpClose(Closed<?> closed) {
        Object closedList = InlineList.m1625constructorimpl$default(null, 1, null);
        while (true) {
            LockFreeLinkedListNode prevNode = closed.getPrevNode();
            Receive previous = prevNode instanceof Receive ? (Receive) prevNode : null;
            if (previous == null) {
                break;
            } else if (!previous.mo1633remove()) {
                previous.helpRemove();
            } else {
                closedList = InlineList.m1630plusFjFbRPM(closedList, previous);
            }
        }
        if (closedList != null) {
