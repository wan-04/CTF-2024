        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t != t2) {
                ...
                if ((t instanceof Object[]) && (t2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m663contentEqualskV0jMPg(((UByteArray) t).m181unboximpl(), ((UByteArray) t2).m181unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UShortArray) && (t2 instanceof UShortArray)) {
                    if (!UArraysKt.m660contentEqualsFGO6Aew(((UShortArray) t).m441unboximpl(), ((UShortArray) t2).m441unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UIntArray) && (t2 instanceof UIntArray)) {
                    if (!UArraysKt.m661contentEqualsKJPZfPQ(((UIntArray) t).m259unboximpl(), ((UIntArray) t2).m259unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof ULongArray) && (t2 instanceof ULongArray)) {
                    if (!UArraysKt.m665contentEqualslec5QzE(((ULongArray) t).m337unboximpl(), ((ULongArray) t2).m337unboximpl())) {
                        return false;
                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder result, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                result.append(UArraysKt.m677contentToString2csIQuQ(uByteArray != null ? uByteArray.m181unboximpl() : null));
            } else if (t instanceof UShortArray) {
                UShortArray uShortArray = (UShortArray) t;
                result.append(UArraysKt.m681contentToStringd6D3K8(uShortArray != null ? uShortArray.m441unboximpl() : null));
            } else if (t instanceof UIntArray) {
                UIntArray uIntArray = (UIntArray) t;
                result.append(UArraysKt.m680contentToStringXUkPCBk(uIntArray != null ? uIntArray.m259unboximpl() : null));
            } else if (t instanceof ULongArray) {
                ULongArray uLongArray = (ULongArray) t;
                result.append(UArraysKt.m683contentToStringuLth9ew(uLongArray != null ? uLongArray.m337unboximpl() : null));
            } else {
