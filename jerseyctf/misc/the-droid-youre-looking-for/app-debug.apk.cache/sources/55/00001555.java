...
public final class DebugStringsKt {
    ...
    public static final String toDebugString(Continuation<?> continuation) {
        String m97constructorimpl;
        if (continuation instanceof DispatchedContinuation) {
            return continuation.toString();
        }
        try {
            Result.Companion companion = Result.Companion;
            m97constructorimpl = Result.m97constructorimpl(continuation + '@' + getHexAddress(continuation));
        } catch (Throwable th) {
        ...
        if (Result.m100exceptionOrNullimpl(m97constructorimpl) != null) {
            m97constructorimpl = ((Object) continuation.getClass().getName()) + '@' + getHexAddress(continuation);
        }
