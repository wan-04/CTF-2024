...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    */
    public final java.lang.Object mo1586receiveCatchingJP2dKIU(kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r6) {
        /*
            r5 = this;
        ...
        L32:
            ...
            java.lang.Object r3 = r3.m1606closedJP2dKIU(r4)
            goto L56
        L50:
            kotlinx.coroutines.channels.ChannelResult$Companion r3 = kotlinx.coroutines.channels.ChannelResult.Companion
            java.lang.Object r3 = r3.m1608successJP2dKIU(r1)
        L56:
            return r3
        L57:
            r3 = 1
        ...
        L61:
            ...
            java.lang.Object r1 = r2.m1605unboximpl()
            return r1
        */
    ...
    public final Object mo1587tryReceivePtdJZtk() {
        Object result = pollInternal();
        return result == AbstractChannelKt.POLL_FAILED ? ChannelResult.Companion.m1607failurePtdJZtk() : result instanceof Closed ? ChannelResult.Companion.m1606closedJP2dKIU(((Closed) result).closeCause) : ChannelResult.Companion.m1608successJP2dKIU(result);
    }
    ...
    public void onCancelIdempotent(boolean wasClosed) {
        ...
        Object list = InlineList.m1625constructorimpl$default(null, 1, null);
        while (true) {
            ...
            if (!(previous instanceof LockFreeLinkedListHead)) {
                ...
                if (!previous.mo1633remove()) {
                    previous.helpRemove();
                } else {
                    list = InlineList.m1630plusFjFbRPM(list, (Send) previous);
                }
            } else {
                mo1585onCancelIdempotentListww6eGU(list, closed);
                return;
            }
        }
    }
    ...
    protected void mo1585onCancelIdempotentListww6eGU(Object list, Closed<?> closed) {
        if (list == null) {
            return;
        }
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int receiveMode, Object value) {
        if (value instanceof Closed) {
            switch (receiveMode) {
                ...
                case 1:
                    if (selectInstance.trySelect()) {
                        UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m1593boximpl(ChannelResult.Companion.m1606closedJP2dKIU(((Closed) value).closeCause)), selectInstance.getCompletion());
                        return;
                    }
                    return;
                default:
            ...
            Object $this$toResult$iv = ChannelResult.m1593boximpl(value instanceof Closed ? ChannelResult.Companion.m1606closedJP2dKIU(((Closed) value).closeCause) : ChannelResult.Companion.m1608successJP2dKIU(value));
            ...
            while (true) {
                ...
                if (result instanceof Closed) {
                    if (((Closed) result).closeCause == null) {
                        ...
                        cont.resumeWith(Result.m97constructorimpl(Boxing.boxBoolean(false)));
                    } else {
                        Result.Companion companion2 = Result.Companion;
                        cont.resumeWith(Result.m97constructorimpl(ResultKt.createFailure(((Closed) result).getReceiveException())));
                    }
                } else if (result != AbstractChannelKt.POLL_FAILED) {
    ...
    public static class ReceiveElement<E> extends Receive<E> {
        ...
        public final Object resumeValue(E e) {
            return this.receiveMode == 1 ? ChannelResult.m1593boximpl(ChannelResult.Companion.m1608successJP2dKIU(e)) : e;
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode != 1) {
                Result.Companion companion = Result.Companion;
                this.cont.resumeWith(Result.m97constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
                return;
            }
            Result.Companion companion2 = Result.Companion;
            this.cont.resumeWith(Result.m97constructorimpl(ChannelResult.m1593boximpl(ChannelResult.Companion.m1606closedJP2dKIU(closed.closeCause))));
        }
    ...
    public static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        @Override // kotlinx.coroutines.channels.ReceiveOrClosed
        public void completeResumeReceive(E e) {
            CancellableKt.startCoroutineCancellable(this.block, this.receiveMode == 1 ? ChannelResult.m1593boximpl(ChannelResult.Companion.m1608successJP2dKIU(e)) : e, this.select.getCompletion(), resumeOnCancellationFun(e));
        }
            ...
            if (this.select.trySelect()) {
                switch (this.receiveMode) {
                    case 0:
                        ...
                        return;
                    case 1:
                        CancellableKt.startCoroutineCancellable$default(this.block, ChannelResult.m1593boximpl(ChannelResult.Companion.m1606closedJP2dKIU(closed.closeCause)), this.select.getCompletion(), null, 4, null);
                        return;
                    default:
                        return;
                }
