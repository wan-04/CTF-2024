...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            obj = Result.m97constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            obj = Result.m97constructorimpl(ResultKt.createFailure(th));
        }
        ...
        try {
            ...
            obj2 = Result.m97constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.Companion;
            obj2 = Result.m97constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m100exceptionOrNullimpl(obj2) == null) {
            obj3 = obj2;
        }
